...
exports.default = () => {
    ...
    return {
        ...
        apiKeyTimeOffsetSeconds: parseInt(process.env.API_KEY_TIME_OFFSET_SECONDS ?? '0', 10),
        ...
        trustProxyHops: parseInt(process.env.TRUST_PROXY_HOPS ??
            (process.env.NODE_ENV === 'production' ? '1' : '0'), 10),
        ...
        ensSocketUrl: (process.env.ENS_SOCKET_URL ??
        ...
        fcmReconcileIntervalMs: parseInt(process.env.FCM_RECONCILE_INTERVAL_MS ?? '3000', 10),
        fcmUncoveredReadyMs: parseInt(process.env.FCM_UNCOVERED_READY_MS ?? '180000', 10),
        fcmPerMenuRateLimit: parseInt(process.env.FCM_PER_MENU_RATE_LIMIT ?? '30', 10),
