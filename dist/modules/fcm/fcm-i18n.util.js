...
exports.localizeFcmNotification = localizeFcmNotification;
const EN = {
    new_call: {
        title: 'New order',
        body: (ctx) => ctx.channel === 'delivery'
...
function localizeFcmNotification(input) {
...
//# sourceMappingURL=fcm-i18n.util.js.map